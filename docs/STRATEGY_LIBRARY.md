...
## donchian_breakout (v1.0.0) — Trend
...
## bollinger_breakout (v1.0.0) — Trend
...
## supertrend_trend_follow (v1.0.0) — Trend
...
## adx_filtered_breakout (v1.0.0) — Trend
...
## rsi_mean_reversion (v1.0.0) — Mean Reversion
...
## bollinger_reversion (v1.0.0) — Mean Reversion
...
## zscore_reversion (v1.0.0) — Mean Reversion
...
## keltner_reversion (v1.0.0) — Mean Reversion
Entry rule: ENTER_LONG if close_t < lower_t. ENTER_SHORT if close_t > upper_t.
Exit rule: EXIT_LONG if close_t >= mid_t. EXIT_SHORT if close_t <= mid_t.
Indicators:
...
## stochastic_momentum (v1.0.0) — Momentum
...
## atr_volatility_breakout (v1.0.0) — Volatility
...
## bb_keltner_squeeze_release (v1.0.0) — Volatility
...
## pivot_breakout (v1.0.0) — Structure
...
## sr_retest_rule_based (v1.0.0) — Structure
...
## time_based_exit_wrapper (v1.0.0) — Wrapper
...
## trailing_stop_wrapper (v1.0.0) — Wrapper
Entry rule: No entries; wrapper never emits ENTER intents.
...
## fixed_rr_stop_target_wrapper (v1.0.0) — Wrapper
Entry rule: No entries; wrapper never emits ENTER intents.
