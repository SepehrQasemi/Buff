...
| docs/CHATBOT_SPEC.md | 2511 | 9873e0e | 2026-02-08 | Add phase-0 product spec files | H1: L1: CHATBOT_SPEC - AI Assistant (Guide + Reviewer)<br>H2: L3: Purpose; L12: Modes; L32: Flow 1: Add Indicator; L50: Flow 2: Add Strategy; L68: Flow 3: Review Strategy/Indicator; L84: Flow 4: Troubleshoot Errors; L90: Non-negotiable Safety Rules; L97: -Exact Steps- Requirement |
...
| docs/DECISIONS.md | 1150 | 4e68d03 | 2026-02-14 | chore(layer1): close out core stabilization invariants (#171) | H1: L2: Decisions (Canonical)<br>H2: L6: D-001 — UI data input is file-based; L12: D-002 — User runs have a single truth source; L17: D-003 — Core boundaries are non-negotiable |
| docs/DELIVERY_CHECKLIST.md | 4651 | 4e68d03 | 2026-02-14 | chore(layer1): close out core stabilization invariants (#171) | H1: L2: Delivery Checklist (Operational)<br>H2: L6: Preconditions; L11: Proof Set A — Clean repo and reproducible environment; L16: Proof Set B — Quality gates (must pass); L29: Proof Set C — Create a run and observe it end-to-end; L61: Proof Set D — Storage and registry invariants; L71: Proof Set E — Failure modes are user-explainable; L91: Documentation links |
...
| docs/STRATEGY_LIBRARY.md | 15910 | 45317af | 2026-02-08 | Phase 2: Built-in Strategy Pack v1 (20 strategies + registry adapter + tests) (#138) | H1: L1: Strategy Library<br>H2: L6: sma_crossover (v1.0.0) - Trend; L17: ema_crossover (v1.0.0) - Trend; L28: donchian_breakout (v1.0.0) - Trend; L40: bollinger_breakout (v1.0.0) - Trend; L53: supertrend_trend_follow (v1.0.0) - Trend; L69: adx_filtered_breakout (v1.0.0) - Trend; L88: rsi_mean_reversion (v1.0.0) - Mean Reversion; L103: bollinger_reversion (v1.0.0) - Mean Reversion; L116: zscore_reversion (v1.0.0) - Mean Reversion; L129: keltner_reversion (v1.0.0) - Mean Reversion; L143: macd_momentum (v1.0.0) - Momentum; L158: roc_momentum (v1.0.0) - Momentum; L170: stochastic_momentum (v1.0.0) - Momentum; L187: atr_volatility_breakout (v1.0.0) - Volatility; L202: bb_keltner_squeeze_release (v1.0.0) - Volatility; L218: pivot_breakout (v1.0.0) - Structure; L231: sr_retest_rule_based (v1.0.0) - Structure; L244: time_based_exit_wrapper (v1.0.0) - Wrapper; L254: trailing_stop_wrapper (v1.0.0) - Wrapper; L264: fixed_rr_stop_target_wrapper (v1.0.0) - Wrapper |
| docs/STRATEGY_PACK_SPEC.md | 1882 | 9873e0e | 2026-02-08 | Add phase-0 product spec files | H1: L1: STRATEGY_PACK_SPEC - Built-in Strategy Catalog (20)<br>H2: L3: Goal; L10: Rules for Inclusion; L21: Categories and Initial List (20); L54: Standard Outputs (must be consistent); L63: Parameter Schema Conventions; L69: Testing Minimum |
...
| docs/USER_JOURNEY.md | 1953 | 396c7df | 2026-02-13 | docs: add roadmap, decisions, and delivery checklist (#170) | H1: L2: User Journey (Official)<br>H2: L6: Journey 1 — Create a run and inspect results; L35: Journey 2 — Reproduce the same run; L40: Journey 3 — Error recovery (must be user-explainable); L48: Notes on file-based data input |
...
Canonical source: [05_RUNBOOK_DEV_WORKFLOW.md](./05_RUNBOOK_DEV_WORKFLOW.md).
