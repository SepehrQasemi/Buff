...
## Proof Set A â€” Clean repo and reproducible environment
...
## Proof Set B â€” Quality gates (must pass)
...
## Proof Set C â€” Create a run and observe it end-to-end
### C1) Create via UI
...
## Proof Set D â€” Storage and registry invariants
Proof requirements:
...
## Proof Set E â€” Failure modes are user-explainable
