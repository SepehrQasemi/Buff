...
- `00:00:00`â€“`00:04:59` â†’ window start `00:00:00`
- `00:05:00`â€“`00:09:59` â†’ window start `00:05:00`
...
exactly `timeframe_seconds / 60` oneâ€‘minute bars.

This prevents lookahead: truncating future minutes removes or changes the final bar.

## Determinism

Given identical input, the output is byteâ€‘forâ€‘byte identical:
- stable ordering
- no randomness
